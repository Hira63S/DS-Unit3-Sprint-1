...
Code review are helpful especially for teams working together so that you don't gets too comfortable in your own style of writing but try to keep it 'general'.
Code review shouldn't be super-critical but should also address parts like proper syntax and readability. I pay attention to syntax as  that is the most important part. But then, readability and if it coherent and not a spaghetti code.
...
- We have an awful lot of computers here, and it gets pretty confusing with
 ...
 They help in moving packages of codes and dependencies across computing environments. A developer can package up an application with all of the parts like libraries and dependencies and can move it as one package.
