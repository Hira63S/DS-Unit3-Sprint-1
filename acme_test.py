...
class AcmeReportTests(unittest.TestCase):
    ...
    def test_legal_names(self):
        ...
        # use assert in to check if all the names generated
        # were valid names to generate, shouldn't be hard
        ...
        for product in generated_products:
            ...
            # need to split the product names
            ...
            # assertIn will tell us if they are the valid names found
